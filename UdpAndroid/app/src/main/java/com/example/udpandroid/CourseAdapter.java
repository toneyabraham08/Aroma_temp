...
//                if (isChecked) {
//                    holder.statusSwitch.setChecked(true);
//                    System.out.println("switch is True");
//                    saveSwitchState(model.unique_id, true);
//                } else {
//                    holder.statusSwitch.setChecked(false);
//                    System.out.println("switch is False");
//                }
//            }
//        });
//		boolean switchChecked = holder.statusSwitch.isChecked();
//		System.out.println("Switch is " + (switchChecked ? "checked" : "not checked"));
//		if(switchChecked){
//			holder.statusSwitch.setChecked(true);
//			System.out.println("switch is True");
//		}else {
...
//        SharedPreferences preferences = context.getSharedPreferences("SwitchState", Context.MODE_PRIVATE);
//        return preferences.getBoolean(SWITCH_STATE_KEY + "_" + deviceId, false);
//    }
